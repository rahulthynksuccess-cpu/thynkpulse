...
export default function TermsOfUsePage() {
  ...
  const lastUpdated = pageContent?.lastUpdated ?? 'March 2025'
    ...
    <>
      ...
      <main style={{ minHeight: '100vh', background: '#fff' }}>
        ...
        <div className="legal-hero" style={{
          background: 'var(--terms-hero-bg, linear-gradient(135deg,var(--ink) 0%,var(--ink2) 100%))',
          padding: '96px 5% 56px',
          position: 'relative',
          overflow: 'hidden',
        }}>
          ...
          <div style={{ position: 'absolute', bottom: -80, left: '30%', width: 300, height: 300, borderRadius: '50%', background: 'rgba(255,255,255,.02)', pointerEvents: 'none' }} />
          <div style={{ maxWidth: 800, margin: '0 auto', position: 'relative', zIndex: 1 }}>
            <div style={{ fontFamily: 'var(--font-mono)', fontSize: '12px', fontWeight: 700, letterSpacing: '2px', textTransform: 'uppercase', color: 'rgba(255,255,255,.4)', marginBottom: 16 }}>Legal</div>
            <h1 style={{ fontFamily: 'var(--font-serif)', fontSize: 'clamp(36px,5vw,60px)', fontWeight: 900, color: '#fff', marginBottom: 14, letterSpacing: '-1px', lineHeight: 1.1 }}>{pageContent?.heroTitle || 'Terms of Use'}</h1>
            <p style={{ fontSize: '16px', color: 'rgba(255,255,255,.5)', fontWeight: 300 }}>Last updated: {lastUpdated}</p>
          </div>
        </div>
        ...
        <div className="legal-content" style={{ maxWidth: 800, margin: '0 auto', padding: '64px 5% 80px' }}>
          ...
          <div style={{ background: '#FFF9E6', border: '1.5px solid rgba(201,146,42,.2)', borderRadius: 16, padding: '24px 28px', marginBottom: 40, fontSize: 14, color: 'var(--muted)', lineHeight: 1.8 }}>
            <strong style={{ color: 'var(--gold)' }}>Please read carefully:</strong>{' '}
            By creating an account or using Thynk Pulse, you agree to these Terms of Use. If you do not agree, please do not use the platform.
          </div>

          <Section title="1. About Thynk Pulse">
            <P>Thynk Pulse is a free community platform operated by Thynk Success for education professionals. These Terms of Use govern your use of the Thynk Pulse website and all associated services.</P>
          ...
          <Section title="3. Content You Post">
            ...
            <P>You retain ownership of all content you create and post on Thynk Pulse. By publishing content, you grant Thynk Pulse a non-exclusive, royalty-free license to display, distribute, and promote your content on the platform.</P>
          ...
          <Section title="4. Community Guidelines">
            ...
            <UL items={[
              ...
              "Disclose any conflicts of interest (e.g., if you're affiliated with a product you review)",
              'Not impersonate other individuals, organizations, or brands',
              "Not solicit other members outside the platform's intended purpose",
              'Not engage in coordinated campaigns to manipulate votes, followers, or visibility',
            ]} />
          </Section>

          <Section title="5. Content Moderation">
            <P>Thynk Pulse reserves the right to review, edit, or remove any content that violates these Terms without prior notice. We may:</P>
            <UL items={[
            ...
            <P>Content moderation decisions are at our sole discretion. Contact us at <a href="mailto:community@thynksuccess.com" style={{ color: 'var(--teal)' }}>community@thynksuccess.com</a> if you believe content was incorrectly removed.</P>
          </Section>

          <Section title="6. Intellectual Property">
            <SubHeading>6.1 Platform Content</SubHeading>
            <P>All platform design, logos, trademarks, and non-user-generated content are owned by Thynk Success and protected by intellectual property laws.</P>

            <SubHeading>6.2 User Content Rights</SubHeading>
            <P>You confirm that you have all necessary rights to post the content you publish on Thynk Pulse. If you post content that infringes someone else's rights, you are solely responsible for any resulting claims or legal liability.</P>

            <SubHeading>6.3 Reporting Infringement</SubHeading>
            <P>Contact us at <a href="mailto:legal@thynksuccess.com" style={{ color: 'var(--teal)' }}>legal@thynksuccess.com</a> if you believe your intellectual property rights have been infringed.</P>
          </Section>

          <Section title="7. Privacy">
            <P>Your use of Thynk Pulse is also governed by our <Link href="/privacy" style={{ color: 'var(--teal)' }}>Privacy Policy</Link>, which is incorporated into these Terms by reference.</P>
          </Section>
          ...
          <Section title="9. Limitation of Liability">
            <P>To the maximum extent permitted by applicable law, Thynk Success shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of Thynk Pulse, including damages related to:</P>
            <UL items={[
          ...
          <Section title="11. Changes to These Terms">
            <P>We may update these Terms from time to time. For significant changes, we will notify you by email and display a notice on the platform.</P>
