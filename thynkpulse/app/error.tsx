...
export default function Error({
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--error-bg, #FDF6EC)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 20px' }}>
      <div style={{ maxWidth: '560px', width: '100%', textAlign: 'center' }}>
        <div style={{ fontSize: '48px', marginBottom: '16px' }}>⚠️</div>
        <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 'var(--error-title-size, 28px)', fontWeight: 900, color: 'var(--error-h1-color, #1A1208)', marginBottom: '12px' }}>
