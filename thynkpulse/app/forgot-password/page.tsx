      ...
      {!sent ? (
        <>
          ...
          <div style={{ textAlign: 'center', marginBottom: '24px' }}>
            <div style={{ width: 56, height: 56, borderRadius: '50%', background: 'rgba(10,95,85,.08)', border: '2px solid rgba(10,95,85,.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px' }}>
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '12px', color: 'var(--muted)', marginBottom: '20px' }}>
            Didn&apos;t receive it?{' '}
            <button onClick={() => setSent(false)} style={{ background: 'none', border: 'none', color: 'var(--teal)', cursor: 'pointer', fontSize: '12px', fontWeight: 700, padding: 0 }}>
              Try again
            </button>
          </p>
