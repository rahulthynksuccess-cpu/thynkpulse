...
export default function WritePage() {
  ...
  if (!isAuthenticated) {
    return (
      <div style={{ minHeight:'100vh', background:'var(--write-bg,var(--cream))', display:'flex', alignItems:'center', justifyContent:'center' }}>
  ...
  if (!user?.profile?.profileCompleted) {
    return (
      <div style={{ minHeight:'100vh', background:'var(--write-bg,var(--cream))', display:'flex', alignItems:'center', justifyContent:'center', padding:'40px 20px' }}>
  ...
  return (
    <div style={{ minHeight:'100vh', background:'var(--write-bg,var(--cream))' }}>
      {/* Top bar */}
