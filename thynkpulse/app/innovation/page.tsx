  ...
  return (
    <>
      ...
      <main style={{ minHeight: '100vh', background: 'var(--cream)' }}>
        ...
        <div style={{
          background: 'var(--innovation-hero-bg, linear-gradient(135deg,#3D1F5E 0%,#6B35A8 50%,#0A5F55 100%))',
          padding: '96px 5% 52px',
          position: 'relative',
          overflow: 'hidden',
        }}>
          ...
          <div style={{ maxWidth: 800, position: 'relative', zIndex: 1 }}>
            ...
            <p style={{ fontSize: '18px', color: 'rgba(255,255,255,.8)', lineHeight: 1.75, maxWidth: 580, fontWeight: 300 }}>
                ...
                <div style={{ padding: '40px 36px', background: '#fff', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: '14px', color: 'var(--muted)' }}>{featured.readTime} min read</div>
                    </div>
        ...
        <div style={{ background: 'linear-gradient(135deg,#3D1F5E 0%,#0A5F55 100%)', padding: '72px 5%', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <p style={{ fontSize: 18, color: 'rgba(255,255,255,.8)', maxWidth: 500, margin: '0 auto 44px', lineHeight: 1.75, fontWeight: 300 }}>
              Share your breakthrough ideas and experiments with 10,000+ education professionals. Free forever.
            </p>
