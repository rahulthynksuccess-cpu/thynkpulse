...
export default function LoginPage() {
  ...
  return (
    <div style={{ minHeight:'100vh', background:'var(--login-bg,var(--cream))', display:'flex', alignItems:'center', justifyContent:'center', padding:'40px 20px' }}>
      ...
      <div style={{ width:'100%', maxWidth:'440px', position:'relative', zIndex:1 }}>
        ...
        <div className="card" style={{ padding:'36px' }}>
          <h1 style={{ fontFamily:'var(--font-serif)', fontSize:'30px', fontWeight:900, color:'var(--login-h1-color,var(--ink))', marginBottom:'6px', letterSpacing:'-0.5px' }}>Welcome back</h1>
          ...
          <form onSubmit={handleSubmit} style={{ display:'flex', flexDirection:'column', gap:'16px' }}>
            ...
            <div style={{ textAlign:'right', marginTop:'-4px' }}>
              <Link href="/forgot-password" style={{ fontSize:'12px', color:'var(--teal)', textDecoration:'none', fontFamily:'var(--font-sans)', fontWeight:500 }}>
                Forgot password?
              </Link>
            </div>
