...
const COMMUNITIES = [
  ...
  { emoji: '👨‍👩‍👧', gradient: 'linear-gradient(135deg,#FFF0F8,#F5C8E5)', title: 'Parents & Guardians', desc: 'Stay informed about education trends, school choices, and how to support your Kids learning journey.', count: '800+', unit: 'parents', color: '#C2407A', category: 'Parent' },
]
        ...
        <div className="page-hero" style={{ background: 'linear-gradient(135deg,var(--teal) 0%,#0D7A6D 60%,var(--plum) 100%)', padding: '96px 5% 56px', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ maxWidth: 800, position: 'relative', zIndex: 1 }}>
            ...
            <h1 style={{ fontFamily: 'var(--font-serif)', fontSize: 'clamp(32px,5vw,60px)', fontWeight: 900, color: 'var(--community-hero-color,#fff)', lineHeight: 1.1, marginBottom: 16 }}>
              {pageContent?.heroTitle || "India's Education"}<br /><em style={{ color: 'var(--gold2)' }}>{pageContent?.heroAccent || 'Community'}</em>
            </h1>
