...
const PAGES: { label: string; icon: string; sections: { id: string; label: string; fields: Field[] }[] }[] = [
    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          { id:'_dup_cta.headlineColor',  label:'Headline colour',      type:'color',  cssVar:'--cta-h2-color',           default:'#ffffff' },
          { id:'_dup_cta.headlineSize',   label:'Headline font size',   type:'size',   cssVar:'--cta-h2-size',            default:'38', min:20, max:72 },
          { id:'_dup_cta.subtitleColor',  label:'Subtitle colour',      type:'color',  cssVar:'--cta-subtitle-color',     default:'rgba(255,255,255,0.75)' },
          { id:'_dup_cta.btnBg',          label:'Button background',    type:'color',  cssVar:'--cta-btn-bg',             default:'#E8512A' },
          { id:'_dup_cta.btnColor',       label:'Button text colour',   type:'color',  cssVar:'--cta-btn-color',          default:'#ffffff' },
          { id:'_dup_cta.btnText',        label:'Button text',          type:'text',   cssVar:'--cta-btn-text',           default:'Join Free →' },
          { id:'_dup_cta.btnSize',        label:'Button font size',     type:'size',   cssVar:'--cta-btn-size',           default:'15', min:12, max:22 },
          { id:'cta.inputPlaceholder',label:'Email placeholder',   type:'text',   cssVar:'--cta-input-placeholder',  default:'Enter your work email' },
          { id:'_dup_cta.footnote',       label:'Footnote text',        type:'text',   cssVar:'--cta-footnote',           default:'🔒 No spam. No paywall. Free forever.' },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    sections: [
      {
        id: 'inner-hero-text', label: 'Page Hero Text (Eyebrow, Title, Subtitle)',
        fields: [
          { id:'ea.heroEyebrow',  label:'EdTech Articles — Eyebrow',       type:'text',    cssVar:'--ea-eyebrow',  default:'EdTech Category' },
          { id:'ea.heroTitle',    label:'EdTech Articles — Title',          type:'text',    cssVar:'--ea-title',    default:'EdTech Articles' },
          { id:'ea.heroSubtitle', label:'EdTech Articles — Subtitle',       type:'textarea',cssVar:'--ea-subtitle', default:'In-depth analysis, product deep-dives, funding news, and thought leadership.' },
          { id:'es.heroEyebrow',  label:'EdTech Stories — Eyebrow',         type:'text',    cssVar:'--es-eyebrow',  default:'✍️ Real Stories' },
          { id:'es.heroTitle',    label:'EdTech Stories — Title',           type:'text',    cssVar:'--es-title',    default:'EdTech Stories' },
          { id:'es.heroSubtitle', label:'EdTech Stories — Subtitle',        type:'textarea',cssVar:'--es-subtitle', default:'Personal narratives from educators and EdTech professionals.' },
          { id:'sl.heroEyebrow',  label:'School Leadership — Eyebrow',      type:'text',    cssVar:'--sl-eyebrow',  default:'🏆 School Leadership' },
          { id:'sl.heroTitle',    label:'School Leadership — Title',         type:'text',    cssVar:'--sl-title',    default:'School Leadership' },
          { id:'sl.heroSubtitle', label:'School Leadership — Subtitle',      type:'textarea',cssVar:'--sl-subtitle', default:'Insights from principals, directors, and administrators.' },
          { id:'in.heroEyebrow',  label:'Innovation — Eyebrow',             type:'text',    cssVar:'--in-eyebrow',  default:'💡 Innovation Hub' },
          { id:'in.heroTitle',    label:'Innovation — Title',               type:'text',    cssVar:'--in-title',    default:'Innovation in Education' },
          { id:'in.heroSubtitle', label:'Innovation — Subtitle',            type:'textarea',cssVar:'--in-subtitle', default:'Cutting-edge ideas, experimental models, and real-world case studies.' },
          { id:'tr.heroTitle',    label:'Trending — Title',                 type:'text',    cssVar:'--tr-title',    default:'Trending Now' },
          { id:'tr.heroSubtitle', label:'Trending — Subtitle',              type:'textarea',cssVar:'--tr-subtitle', default:"The articles the community can't stop reading, sharing, and discussing right now." },
          { id:'wr.heroTitle',    label:'Writers — Title',                  type:'text',    cssVar:'--wr-title',    default:'Meet the Writers' },
          { id:'wr.heroSubtitle', label:'Writers — Subtitle',               type:'textarea',cssVar:'--wr-subtitle', default:"Educators, founders, researchers, and leaders sharing their expertise." },
          { id:'com.heroTitle',   label:'Community — Title',                type:'text',    cssVar:'--com-title',   default:"India's Education" },
          { id:'com.heroAccent',  label:'Community — Accent word',          type:'text',    cssVar:'--com-accent',  default:'Community' },
          { id:'com.heroSubtitle',label:'Community — Subtitle',             type:'textarea',cssVar:'--com-subtitle',default:'Connect with 10,000+ educators, EdTech founders, school leaders, and researchers.' },
          { id:'com.heroEyebrow', label:'Community — Eyebrow',              type:'text',    cssVar:'--com-eyebrow', default:'🤝 Community Hub' },
        ],
      },
      {
        id: 'inner-hero-style', label: 'Page Hero Colours & Sizes',
        fields: [
          { id:'lp.heroBg',          label:'Latest Posts hero background',  type:'color', cssVar:'--latest-posts-hero-bg',   default:'#0A5F55' },
          { id:'lp.heroColor',       label:'Latest Posts hero text colour', type:'color', cssVar:'--latest-posts-hero-color',default:'#ffffff' },
          { id:'lp.pageBg',          label:'Latest Posts page background',  type:'color', cssVar:'--latest-posts-bg',        default:'#FDF6EC' },
          { id:'tr2.heroBg',         label:'Trending hero background',      type:'color', cssVar:'--trending-hero-bg',       default:'#E8512A' },
          { id:'tr2.heroColor',       label:'Trending hero text colour',     type:'color', cssVar:'--trending-hero-color',    default:'#ffffff' },
          { id:'com2.heroBg',        label:'Community hero background',     type:'color', cssVar:'--community-hero-bg',      default:'#0A5F55' },
          { id:'com2.heroColor',     label:'Community hero text colour',    type:'color', cssVar:'--community-hero-color',   default:'#ffffff' },
          { id:'wr2.heroBg',         label:'Writers hero background',       type:'color', cssVar:'--writers-hero-bg',        default:'#0A5F55' },
          { id:'wr2.heroColor',      label:'Writers hero text colour',      type:'color', cssVar:'--writers-hero-color',     default:'#ffffff' },
          { id:'ea2.heroBg',         label:'EdTech Articles hero bg',       type:'color', cssVar:'--edtech-hero-bg',         default:'#0A5F55' },
          { id:'es2.heroBg',         label:'EdTech Stories hero bg',        type:'color', cssVar:'--edtech-stories-hero-bg', default:'#3D1F5E' },
          { id:'sl2.heroBg',         label:'School Leadership hero bg',     type:'color', cssVar:'--leadership-hero-bg',     default:'#C9922A' },
          { id:'in2.heroBg',         label:'Innovation hero bg',            type:'color', cssVar:'--innovation-hero-bg',     default:'#3D1F5E' },
        ],
      },
    ],
  },,
    ...
    sections: [
      {
        ...
        fields: [
          ...
          { id:'_dup_comm.cardTitleSize', label:'Card title font size',       type:'size',  cssVar:'--community-card-title-size', default:'20', min:14, max:28 },
          { id:'_dup_comm.cardDescSize',  label:'Card description font size', type:'size',  cssVar:'--community-card-desc-size',  default:'13', min:10, max:18 },
    ...
    sections: [
      {
        ...
        fields: [
          ...
          { id:'_dup_trend.titleColor',   label:'"Trending" title colour',    type:'color', cssVar:'--trending-section-title', default:'#1A1208' },
          { id:'_dup_trend.titleSize',    label:'Section title font size',    type:'size',  cssVar:'--trending-section-title-size', default:'42', min:24, max:72 },
          { id:'trend.accentColor',  label:'Italic accent colour',       type:'color', cssVar:'--trending-accent-color',  default:'#0A5F55' },
          { id:'_dup_trend.rankColor',    label:'Rank number colour (01,02)', type:'color', cssVar:'--trending-num-color',     default:'#EDE0C8' },
          { id:'_dup_trend.rankSize',     label:'Rank number font size',      type:'size',  cssVar:'--trending-rank-size',     default:'32', min:20, max:56 },
          { id:'_dup_trend.catColor',     label:'Category tag colour',        type:'color', cssVar:'--trending-cat-color',     default:'#E8512A' },
          { id:'_dup_trend.catSize',      label:'Category tag font size',     type:'size',  cssVar:'--trending-cat-size',      default:'11', min:9, max:16 },
          ...
          { id:'_dup_trend.metaColor',    label:'Meta text colour (reads,likes)',type:'color',cssVar:'--trending-meta-color',  default:'#7A6A52' },
          { id:'_dup_trend.sidebarBg',    label:'Sidebar card background',    type:'color', cssVar:'--trending-sidebar-bg',    default:'#FDF6EC' },
          { id:'_dup_trend.topicTagBg',   label:'Topic tag background',       type:'color', cssVar:'--topic-tag-bg',           default:'#EDE0C8' },
          { id:'_dup_trend.topicTagColor',label:'Topic tag text colour',      type:'color', cssVar:'--topic-tag-color',        default:'#7A6A52' },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        fields: [
          ...
          { id:'_dup_writ.cardBg',        label:'Profile card background',    type:'color', cssVar:'--writers-card-bg-home',   default:'#ffffff' },
          { id:'_dup_writ.nameColor',     label:'Writer name colour',         type:'color', cssVar:'--writers-name-color',     default:'#1A1208' },
          { id:'_dup_writ.nameSize',      label:'Writer name font size',      type:'size',  cssVar:'--writers-name-size',      default:'18', min:12, max:28 },
          { id:'_dup_writ.roleColor',     label:'Role / location colour',     type:'color', cssVar:'--writers-role-color',     default:'#7A6A52' },
          { id:'_dup_writ.roleSize',      label:'Role font size',             type:'size',  cssVar:'--writers-role-size',      default:'13', min:10, max:18 },
          { id:'_dup_writ.statNumColor',  label:'Stats number colour (48, 12K)', type:'color', cssVar:'--writers-stat-num-color', default:'#1A1208' },
          { id:'_dup_writ.statNumSize',   label:'Stats number font size',     type:'size',  cssVar:'--writers-stat-num-size',  default:'28', min:16, max:48 },
          { id:'_dup_writ.statLabelColor',label:'Stats label colour (Articles, Followers)', type:'color', cssVar:'--writers-stat-label-color', default:'#7A6A52' },
          { id:'writ.featureBg',     label:'Feature list item background',type:'color',cssVar:'--writers-feature-bg',    default:'rgba(10,95,85,0.06)' },
          { id:'_dup_writ.featureTitleColor',label:'Feature title colour',    type:'color', cssVar:'--writers-feature-title-color', default:'#1A1208' },
          { id:'_dup_writ.featureTitleSize', label:'Feature title font size', type:'size',  cssVar:'--writers-feature-title-size',  default:'15', min:11, max:22 },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        fields: [
          { id:'_dup_mq.bg',         label:'Bar background colour',    type:'color', cssVar:'--marquee-bg',         default:'#0A5F55' },
          { id:'_dup_mq.textColor',  label:'Text colour',              type:'color', cssVar:'--marquee-text-color',  default:'rgba(255,255,255,0.8)' },
          { id:'_dup_mq.dotColor',   label:'Dot separator colour',     type:'color', cssVar:'--marquee-dot-color',   default:'#12A090' },
          { id:'_dup_mq.fontSize',   label:'Font size',                type:'size',  cssVar:'--marquee-font-size',   default:'13', min:10, max:18 },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    sections: [
      {
        id: 'communities-style', label: 'Card Styling',
        fields: [
          { id:'comm.cardTitleColor', label:'Card title colour',       type:'color', cssVar:'--community-card-title-color', default:'#1A1208' },
          { id:'comm.cardTitleSize',  label:'Card title font size',    type:'size',  cssVar:'--community-card-title-size',  default:'20', min:14, max:32 },
          { id:'comm.cardDescColor',  label:'Card description colour', type:'color', cssVar:'--community-card-desc-color',  default:'#7A6A52' },
          { id:'comm.cardDescSize',   label:'Card description size',   type:'size',  cssVar:'--community-card-desc-size',   default:'13', min:10, max:18 },
          { id:'comm.cardCountSize',  label:'Member count font size',  type:'size',  cssVar:'--community-count-size',       default:'12', min:9,  max:16 },
        ],
      },
      {
        id: 'communities-text', label: 'Card Text Content',
        fields: [
          { id:'comm1.title', label:'Card 1 — Title',        type:'text',    cssVar:'--comm-1-title', default:'Educators & Teachers' },
          { id:'comm1.desc',  label:'Card 1 — Description',  type:'textarea',cssVar:'--comm-1-desc',  default:'Share classroom innovations, teaching methods, and real challenges. Connect with peers across schools worldwide.' },
          ...
          { id:'comm2.desc',  label:'Card 2 — Description',  type:'textarea',cssVar:'--comm-2-desc',  default:'Publish thought leadership, product insights, and case studies. Build authentic trust with educators.' },
          ...
          { id:'comm3.desc',  label:'Card 3 — Description',  type:'textarea',cssVar:'--comm-3-desc',  default:'Real conversations about selling in education — strategies, objections, and what actually closes deals.' },
          ...
          { id:'comm4.desc',  label:'Card 4 — Description',  type:'textarea',cssVar:'--comm-4-desc',  default:'Principals and administrators sharing governance insights, procurement decisions, and transformation stories.' },
          ...
          { id:'comm5.desc',  label:'Card 5 — Description',  type:'textarea',cssVar:'--comm-5-desc',  default:'Bridge the gap between academic research and classroom practice. Make findings accessible and actionable.' },
          ...
          { id:'comm6.desc',  label:'Card 6 — Description',  type:'textarea',cssVar:'--comm-6-desc',  default:'Education challenges are global. Connect with practitioners from 40+ countries and diverse education systems.' },
  ...
  },
  {
    ...
    sections: [
      {
        id: 'trending-style', label: 'Trending Styling',
        fields: [
          ...
          { id:'trend.titleColor',   label:'Article title colour',       type:'color', cssVar:'--trending-title-color',        default:'#1A1208' },
          { id:'trend.titleSize',    label:'Article title font size',    type:'size',  cssVar:'--trending-title-size',         default:'17', min:12, max:26 },
          { id:'trend.metaColor',    label:'Meta text colour',           type:'color', cssVar:'--trending-meta-color',         default:'#7A6A52' },
          ...
          { id:'trend.sidebarBg',    label:'Sidebar background',         type:'color', cssVar:'--trending-sidebar-bg',         default:'#FDF6EC' },
        ],
      },
      {
        id: 'trending-text', label: 'Article Titles & Topics',
        fields: [
  ...
  },
  {
    ...
    sections: [
      {
        id: 'writers-style', label: 'Writers Section Styling',
        fields: [
          { id:'writ.nameColor',        label:'Writer name colour',          type:'color', cssVar:'--writers-name-color',         default:'#1A1208' },
          { id:'writ.nameSize',         label:'Writer name font size',       type:'size',  cssVar:'--writers-name-size',          default:'20', min:14, max:32 },
          { id:'writ.roleColor',        label:'Role / location colour',      type:'color', cssVar:'--writers-role-color',         default:'#7A6A52' },
          { id:'writ.roleSize',         label:'Role font size',              type:'size',  cssVar:'--writers-role-size',          default:'12', min:10, max:18 },
          { id:'writ.statNumColor',     label:'Stats number colour',         type:'color', cssVar:'--writers-stat-num-color',     default:'#1A1208' },
          { id:'writ.statNumSize',      label:'Stats number font size',      type:'size',  cssVar:'--writers-stat-num-size',      default:'24', min:16, max:40 },
          { id:'writ.statLabelColor',   label:'Stats label colour',          type:'color', cssVar:'--writers-stat-label-color',   default:'#7A6A52' },
          { id:'writ.featureTitleColor',label:'Feature title colour',        type:'color', cssVar:'--writers-feature-title-color',default:'#1A1208' },
          { id:'writ.featureTitleSize', label:'Feature title font size',     type:'size',  cssVar:'--writers-feature-title-size', default:'16', min:12, max:22 },
          { id:'writ.featureDescColor', label:'Feature description colour',  type:'color', cssVar:'--writers-feature-desc-color', default:'#7A6A52' },
          { id:'writ.featureDescSize',  label:'Feature description size',    type:'size',  cssVar:'--writers-feature-desc-size',  default:'13', min:10, max:18 },
          { id:'writ.sectionBg',        label:'Section background',          type:'color', cssVar:'--writers-section-bg',         default:'#FDF6EC' },
  ...
  },
  {
    ...
    sections: [
      {
        id: 'cta-style', label: 'CTA Section Styling',
        fields: [
          { id:'cta.sectionBg',      label:'Section background colour',  type:'color', cssVar:'--cta-bg',             default:'#0A5F55' },
          ...
          { id:'cta.btnBg',          label:'Button background colour',   type:'color', cssVar:'--cta-btn-bg',          default:'#E8512A' },
          ...
          { id:'cta.featCardBg',     label:'Feature card background',    type:'color', cssVar:'--cta-feat-card-bg',    default:'rgba(255,255,255,0.08)' },
          { id:'cta.featTitleColor', label:'Feature title colour',       type:'color', cssVar:'--cta-feat-title-color',default:'#ffffff' },
          { id:'cta.featTitleSize',  label:'Feature title font size',    type:'size',  cssVar:'--cta-feat-title-size', default:'14', min:11, max:20 },
          { id:'cta.featDescColor',  label:'Feature description colour', type:'color', cssVar:'--cta-feat-desc-color', default:'rgba(255,255,255,0.6)' },
          { id:'cta.featDescSize',   label:'Feature description size',   type:'size',  cssVar:'--cta-feat-desc-size',  default:'12', min:10, max:18 },
        ],
      },
      {
        id: 'cta-text', label: 'CTA Text Content',
        fields: [
  ...
  },
  {
    ...
    sections: [
      {
        id: 'marquee-style', label: 'Marquee Bar Styling',
        fields: [
...
export default function AdminContentPage() {
  ...
  const { data: saved } = useQuery({
    ...
    queryFn: async () => {
      ...
      // Pre-populate inner page text fields
      const innerMap: Record<string,Record<string,string>> = {
        'content.edtech-articles':   { heroEyebrow:'ea.heroEyebrow', heroTitle:'ea.heroTitle', heroSubtitle:'ea.heroSubtitle' },
        'content.edtech-stories':    { heroEyebrow:'es.heroEyebrow', heroTitle:'es.heroTitle', heroSubtitle:'es.heroSubtitle' },
        'content.school-leadership': { heroEyebrow:'sl.heroEyebrow', heroTitle:'sl.heroTitle', heroSubtitle:'sl.heroSubtitle' },
        'content.innovation':        { heroEyebrow:'in.heroEyebrow', heroTitle:'in.heroTitle', heroSubtitle:'in.heroSubtitle' },
      ...
      Object.entries(innerMap).forEach(([key, fieldMap]) => {
        const saved = all[key] ?? {}
        Object.entries(fieldMap).forEach(([contentKey, fieldId]) => {
          if (saved[contentKey]) styles[fieldId] = saved[contentKey]
        })
      })

      // Pre-populate stats text from content.stats
      const statsData = all['content.stats']
      if (Array.isArray(statsData)) {
        statsData.forEach((s:any, i:number) => {
          const n = i+1
          if (s.n) styles[`stats.${n}n`] = s.n
          if (s.l) styles[`stats.${n}l`] = s.l
        })
      }

      // Pre-populate navbar text from content.navbar
      const nav = all['content.navbar'] ?? {}
      if (nav.ctaLabel)   styles['navbar.btnText']   = nav.ctaLabel
      if (nav.loginLabel) styles['navbar.loginText'] = nav.loginLabel

      // Pre-populate footer text from content.footer
      const foot = all['content.footer'] ?? {}
      if (foot.tagline)   styles['footer.tagline']   = foot.tagline
      if (foot.copyright) styles['footer.copyright'] = foot.copyright

      // Pre-populate hero text from content.hero
      const hero = all['content.hero'] ?? {}
      if (hero.eyebrow)      styles['hero.eyebrow']     = hero.eyebrow
      if (hero.h1Line1)      styles['hero.h1Line1']     = hero.h1Line1
      if (hero.h1Line2)      styles['hero.h1Line2']     = hero.h1Line2
  ...
  const pushMutation = useMutation({
    mutationFn: async () => {
      ...
      // Save text fields to content.hero so HeroSection reads them via useContent
      await apiPost('/admin/content', { key: 'content.hero', value: {
        eyebrow:     values['hero.eyebrow']  || "India's Education Community Platform",
        h1Line1:     values['hero.h1Line1']  || 'Where Ideas',
        h1Line2:     values['hero.h1Line2']  || 'Shape Education',
      ...
      // Save inner page content
      const innerPages = [
        { key: 'content.edtech-articles',   vals: { heroEyebrow: values['ea.heroEyebrow'], heroTitle: values['ea.heroTitle'], heroSubtitle: values['ea.heroSubtitle'] } },
        { key: 'content.edtech-stories',    vals: { heroEyebrow: values['es.heroEyebrow'], heroTitle: values['es.heroTitle'], heroSubtitle: values['es.heroSubtitle'] } },
        { key: 'content.school-leadership', vals: { heroEyebrow: values['sl.heroEyebrow'], heroTitle: values['sl.heroTitle'], heroSubtitle: values['sl.heroSubtitle'] } },
        { key: 'content.innovation',        vals: { heroEyebrow: values['in.heroEyebrow'], heroTitle: values['in.heroTitle'], heroSubtitle: values['in.heroSubtitle'] } },
      ...
      // Save stats text (numbers + labels) to content.stats for StatsBar component
      const sups = ['+','+','+','+','%']
      const statsArr = [1,2,3,4,5].map((n,i) => ({
        n:   values[`stats.${n}n`] || ['10K','2.4K','180','40','100'][i],
        sup: sups[i],
        l:   values[`stats.${n}l`] || ['Community Members','Articles Published','EdTech Companies','Countries Represented','Free Forever'][i],
      }))
      await apiPost('/admin/content', { key: 'content.stats', value: statsArr })

      // Save navbar text to content.navbar for Navbar component
      await apiPost('/admin/content', { key: 'content.navbar', value: {
        brandName:  'Thynk Pulse',
        ctaLabel:   values['navbar.btnText']   || 'Start Writing',
        loginLabel: values['navbar.loginText'] || 'Login',
        links: [
      ...
      // Save footer text to content.footer for Footer component
      await apiPost('/admin/content', { key: 'content.footer', value: {
        tagline:   values['footer.tagline']   || 'The free community platform for educators, EdTech professionals, innovators and school leaders.',
        copyright: values['footer.copyright'] || '© 2025 Thynk Pulse. All rights reserved.',
        links: [
