...
export default function EditProfilePage() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      updateUser({ profile: { ...user?.profile, ...form, profileCompleted: true } as any })
  ...
  function back() {
    ...
    else router.push(`/profile/${user?.email || user?.id}`)
  }
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', background: 'var(--profile-setup-bg,#0D1117)', fontFamily: "'DM Sans', sans-serif" }}>
      <style>{`
      ...
      <div className="left-panel" style={{
        ...
        <div style={{ marginBottom:'40px' }}>
          ...
          <h2 style={{ fontFamily:"'Fraunces', serif", fontWeight:900, fontSize:'36px', lineHeight:1.05, color:'#fff', letterSpacing:'-1px', marginBottom:'10px' }}>
            Edit Profile,<br /><em style={{ fontStyle:'italic', color:'#64DCBE' }}>{name}</em>
          </h2>
          <p style={{ fontSize:'14px', color:'rgba(255,255,255,0.45)', lineHeight:1.7, fontWeight:300 }}>
            Update your information to keep your profile fresh and discoverable.
          </p>
        </div>
          ...
          <motion.div key={step}
              ...
              <div style={{ display:'flex', flexDirection:'column', gap:'18px' }}>
                <div>
                  ...
                  <div style={{ position:'relative' }}>
                    ...
                    <input style={{ ...inp, paddingLeft:'42px' }} type="text" placeholder="e.g. Delhi Public School"
                ...
                <div>
                  ...
                  <div style={{ position:'relative' }}>
                    ...
                    <input style={{ ...inp, paddingLeft:'42px' }} type="text" placeholder="e.g. EduTech Ventures"
              ...
              <div style={{ display:'flex', flexDirection:'column', gap:'18px' }}>
                ...
                <div>
                  ...
                  <div style={{ display:'flex', flexWrap:'wrap', gap:'8px', marginBottom:'10px' }}>
                    {['EdTech','AI in Education','School Leadership','Teacher Training','Curriculum Design','STEM','Ed Policy'].map(tag=>{
            ...
            <div style={{ display:'flex', gap:'10px', marginTop:'36px' }}>
              <button onClick={back} type="button"
                ...
                <ArrowLeft style={{ width:15, height:15 }} /> {step === 1 ? 'Cancel' : 'Back'}
              </button>
              ...
              <button onClick={next} disabled={!canNext || loading} type="button"
                ...
                {loading
                  ...
                  : step===4
                    ? <><Sparkles style={{width:16,height:16}}/>Save Profile</>
