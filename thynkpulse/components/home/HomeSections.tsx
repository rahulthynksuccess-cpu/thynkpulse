...
export function StatsBar() {
  return (
    <div style={{ background:'#fff', borderBottom:'1px solid var(--border)', display:'grid', gridTemplateColumns:'repeat(5,1fr)' }}>
      {STATS.map((s, i) => (
        <div key={s.l} style={{ padding:'28px 24px', textAlign:'center', borderRight: i<4 ? '1px solid var(--border)' : 'none', position:'relative', overflow:'hidden' }}>
          <div style={{ fontFamily:'var(--font-serif)', fontSize:'40px', fontWeight:900, color:'var(--ink)', letterSpacing:'-1.5px', lineHeight:1 }}>
