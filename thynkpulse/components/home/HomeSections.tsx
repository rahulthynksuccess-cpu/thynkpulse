...
export function MarqueeSection() {
  const c = useContent('content.marquee')
...
export function CommunitySection() {
  const c = useContent('content.communities')
...
export function ProfileSection() {
  const c = useContent('content.writers-spotlight')
...
export function CTASection() {
  const c = useContent('content.cta-section')
