...
export function CommunitySection() {
  return (
    <section id="community" style={{ padding:'96px 5%', background:'#fff' }}>
      ...
      <div className="comm-grid" className="comm-grid" style={{ display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:'20px', marginTop:'56px' }}>
        {COMMUNITIES.map((c, i) => (
...
export function ProfileSection() {
  ...
  return (
    <section id="writers" style={{ padding:'96px 5%', background:'var(--cta-section-bg,var(--cream))' }}>
