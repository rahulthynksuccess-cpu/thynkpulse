          ...
          <div className="hero-grid">
            ...
            <div>
              ...
              <motion.h1 className="hero-h1"
                ...
                style={{
                  fontSize: c?.h1FontSize ? `${c.h1FontSize}px` : 'var(--hero-h1-size, 84px)',
                  color:    c?.h1Color    ? c.h1Color            : 'var(--hero-h1-color, var(--ink))',
                  fontFamily: c?.h1FontFamily ? `'${c.h1FontFamily}', Georgia, serif` : 'var(--hero-h1-font, var(--font-serif))',
                }}>
                {c.h1Line1}<br />
