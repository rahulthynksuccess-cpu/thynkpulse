  ...
  return (
    <section style={{
      ...
      <div style={{ maxWidth:'1160px', margin:'0 auto', padding:'0 5%', width:'100%' }}>
        ...
        {/* Two-column layout — card hidden on mobile via inline style + media */}
        <div style={{
          display: 'grid',
          ...
          <div>
            ...
            <motion.h1 {...fade(0.18)} style={{
              ...
              fontWeight: 900,
              /* Large desktop: 84px, small desktop: 6vw, tablet: 56px, phone: 48px */
            ...
            <motion.div {...fade(0.32)} style={{ display:'flex', gap:'12px', flexWrap:'wrap', marginBottom:'28px' }}>
              <Link href={isAuthenticated ? '/write' : '/register'} className="btn-teal" style={{ padding:'13px 28px', fontSize:'15px' }}>
          ...
          {/* ── Right card column ── */}
          <motion.div {...fade(0.3)} className="hero-card-col" style={{
            background: '#fff',
            borderRadius: 'var(--radius-xl, 24px)',
            border: '1px solid var(--border)',
            overflow: 'hidden',
            boxShadow: '0 24px 80px rgba(26,18,8,.1)',
            flexShrink: 0,
          }}>
