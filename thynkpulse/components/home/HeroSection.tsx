    ...
    <>
      <style>{`
        ...
        @media (max-width: 1024px) {
          .hero-h1 { font-size: 68px !important; letter-spacing: -3px; }
        ...
        @media (max-width: 768px) {
          ...
          .hero-h1 { font-size: 52px !important; letter-spacing: -2px; line-height: 1.0; }
          .hero-sub { font-size: 15px; max-width: 100%; }
          .hero-btns { flex-direction: column; }
          .hero-btns a { width: 100%; text-align: center; justify-content: center; box-sizing: border-box; }
        }
        @media (max-width: 480px) {
          .hero-h1 { font-size: 44px !important; letter-spacing: -1.5px; }
