                ...
                <AnimatePresence>
                  {profileOpen && (
                    <motion.div initial={{ opacity:0, y:6, scale:.97 }} animate={{ opacity:1, y:0, scale:1 }}
                      ...
                      <Link href="/profile" className="flex items-center gap-[10px] px-[14px] py-[10px] text-[13px] hover:bg-[var(--border2)] transition-colors no-underline" style={{ color: 'var(--ink)' }}>
